...
def main():
    ...
    try:
        ...
        for interval in intervals:
            count_headers.append(f"{interval}数量")

        count_table.field_names = count_headers
        ...
        time_headers = ["品种"]
        for interval in intervals:
            time_headers.append(f"{interval}开始")
            time_headers.append(f"{interval}结束")

        time_table.field_names = time_headers
